  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: '#0b0b0d', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px 0' }}>
        ...
        <div style={{ font: '700 16px/1 system-ui', color: '#fff' }}>장소 가져오기</div>
      ...
      <div style={{ margin: '22px 20px 0', background: 'rgba(255,255,255,.08)', border: '1px solid rgba(255,255,255,.13)', borderRadius: 16, padding: '13px 14px', display: 'flex', alignItems: 'center', gap: 11 }}>
        ...
        <div style={{ flex: 1, font: '500 13px/1.3 system-ui', color: '#fff', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{display}</div>
      ...
      <div style={{ margin: '16px 20px 0', background: 'rgba(255,255,255,.05)', borderRadius: 20, padding: 14, display: 'flex', gap: 13 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}><div style={{ width: 20, height: 20, borderRadius: '50%', background: 'linear-gradient(140deg,#f3a9b9,#d76a8a)' }} /><span style={{ font: '700 12.5px/1 system-ui', color: '#fff' }}>seongsu.foodie</span></div>
          <div style={{ marginTop: 9, font: '500 13px/1.45 system-ui', color: 'rgba(255,255,255,.8)' }}>성수동 갑성비 끝판왕 파스타집 찾았다… 웨이팅 30분 각오</div>
          <div style={{ marginTop: 9, display: 'flex', gap: 6 }}><span style={{ font: '500 11px/1 system-ui', color: '#2997ff' }}>#성수맛집</span><span style={{ font: '500 11px/1 system-ui', color: '#2997ff' }}>#파스타</span></div>
        </div>
      </div>
      ...
      <div style={{ margin: '20px 20px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ font: '700 15px/1 system-ui', color: '#fff' }}>장소를 불러오는 중</span>
        </div>
        <div style={{ marginTop: 10, font: '500 14px/1.4 system-ui', color: 'rgba(255,255,255,.5)' }}>잠시만 기다려 주세요</div>
